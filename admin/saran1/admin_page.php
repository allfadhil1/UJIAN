...
<div class="container">
    <h4><center>DATA SARAN IKAN, PANTAI, DAN TERUMBU KARANG</center></h4>
    <br>
    <?php
    include "config.php";
    ...
    <table class="my-3 table table-bordered">
        ...
        <tr class="table-primary">
            ...
            <th class="password-col">Password Pengguna</th> <!-- Kolom baru -->
        ...
        <?php
                ...
                ?>
                    <tr>
                        ...
                        <td class="password-col"><?php echo $data["Password"]; ?></td> <!-- Menampilkan password pengguna -->
                        <td class="nama-col"><?php echo $data["Nama"]; ?></td>
                        <td class="image-col"><img src="uploaded_img/<?php echo $data["Image"]; ?>" alt="Image" width="100"></td>
