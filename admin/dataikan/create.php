...
<div class="container">
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $sql = "INSERT INTO ikan (nama_ikan, jenis, website) VALUES ('$nama_ikan', '$jenis', '$website')";
    ...
    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post">
        <div class="form-group">
            ...
            <input type="text" name="nama_ikan" class="form-control" placeholder="Masukan Ikan" required />
        </div>
        <div class="form-group">
            <label>Jenis:</label>
