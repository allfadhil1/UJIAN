     ...
     <tr class="table-danger">
       ...
       <table class="my-3 table table-bordered">
        ...
        while ($data = mysqli_fetch_array($hasil)) {
            ...
            <tr>
                <td><?php echo $no;?></td>
                <td><?php echo $data["nama_karang"]; ?></td>
                <td><?php echo $data["jenis"];   ?></td>
                <td><?php echo $data["website"];   ?></td>
    
                <td>
                <a href="update.php?id_karang=<?php echo htmlspecialchars($data['id_karang']); ?>" class="btn btn-warning" role="button">Update</a>
                    <a href="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>?id_karang=<?php echo $data['id_karang']; ?>" class="btn btn-danger" role="button">Delete</a>
                </td>
            </tr>
            </tbody>
            <?php
