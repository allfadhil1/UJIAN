...
<head>
    ...
    <style>
        ...
        .card a.second-btn {
            background-color: #4CAF50; /* Warna hijau untuk tombol kedua */
        }
...
<br><br><br><br>
<h1><center>DAFTAR DIVING</center></h1><br>

<div class="search-container">
<form method="GET" action="">
        <input type="text" name="search" placeholder="Cari Diving...">
...
<?php
    ...
    if ($search_query != "") {
        $query_mysql = mysqli_query($mysql, "SELECT * FROM diving WHERE (nama LIKE '%$search_query%' OR deskripsi LIKE '%$search_query%')") or die(mysqli_error($mysql));
    } else {
        $query_mysql = mysqli_query($mysql, "SELECT * FROM diving") or die(mysqli_error($mysql));
    }
    ...
    <div class="card-image">
        <img src="../admin/datapantai/uploaded_img/<?php echo $data['gambar']; ?>" alt="<?php echo $data['nama']; ?>">
    </div>
    <h2><?php echo $data['nama']; ?></h2>
    <p><?php echo $data['deskripsi']; ?></p>
    <div class="button-container">
        
    <a href="<?php echo $data['website']; ?>" class="btn blue-btn" target="_blank">Read More</a>
    <a href="transaksi.php?id_diving=<?php echo $data['id_diving']; ?>" class="btn green-btn">Pesan</a>
