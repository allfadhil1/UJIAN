...
<div class="search-form">
    <form method="GET" action="">
        <input type="text" name="search" placeholder="Cari Terumbu Karang...">
...
<section class="container">
    ...
    if ($search_query != "") {
        $query_mysql = mysqli_query($mysql, "SELECT * FROM konten WHERE id_kategori = 2 AND (nama LIKE '%$search_query%' OR deskripsi LIKE '%$search_query%')") or die(mysqli_error($mysql));
    } else {
        $query_mysql = mysqli_query($mysql, "SELECT * FROM konten WHERE id_kategori = 2") or die(mysqli_error($mysql));
    }
